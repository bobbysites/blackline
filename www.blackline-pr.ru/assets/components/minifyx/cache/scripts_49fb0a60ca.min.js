...
function slowScroll(id){var offset=150;$('html,body').animate({scrollTop:$(id).offset().top-offset},500);return false;};$(document).ready(function(){var swiper=new Swiper('.swiper-container',{preloadImages:false,lazy:true,loop:true,pagination:{el:'.swiper-pagination',clickable:true,},});new WOW().init();$("#mob_knopka").on("click",function(){$("#mainmenu0001").animate({width:"100%"},400);$('.one').removeClass("mob_menu_active1").addClass("mob_menu_cloze1");$('.two').removeClass("mob_menu_active2").addClass("mob_menu_cloze2");$('.three').removeClass("mob_menu_active3").addClass("mob_menu_cloze3");});$("#mainmenu0001").on("click",function(){$("#mainmenu0001").animate({width:"0%"},400);$('.one').removeClass("mob_menu_cloze1").addClass("mob_menu_active1");$('.two').removeClass("mob_menu_cloze2").addClass("mob_menu_active2");$('.three').removeClass("mob_menu_cloze3").addClass("mob_menu_active3");});$(".phone_mask").mask("+38 (099) 999-99-99");$(window).scroll(function(){if($(this).scrollTop()>700){$('#back-top-wrapper').fadeIn("slow");$('#knop').fadeIn("slow");$('.knop1').fadeIn("slow");$('.knop2').fadeIn("slow");}else{$('#back-top-wrapper').fadeOut("slow");$('#knop').fadeOut("slow");$('.knop1').fadeOut("slow");$('.knop2').fadeOut("slow");}});$('#back-top-wrapper').click(function(){$('body,html').animate({scrollTop:0},500);return false;});$(function(){var spinner=$('.ymap').children('.ymap-preloader');var check_if_load=false;var myMapTemp,myPlacemarkTemp;function init(){var myMapTemp=new ymaps.Map("ymap",{center:[55.786597,37.723511],zoom:16,controls:['zoomControl','fullscreenControl']});var myPlacemarkTemp=new ymaps.Placemark([55.786597,37.723511],{balloonContent:"Россия, Москва, Ткацкая улица, 5с1",},{preset:'islands#redIcon'});myMapTemp.geoObjects.add(myPlacemarkTemp);var layer=myMapTemp.layers.get(0).get(0);waitForTilesLoad(layer).then(function(){spinner.removeClass('is-active');});}
...
var ymap=function(){$('.ymap').mouseenter(function(){if(!check_if_load){check_if_load=true;spinner.addClass('is-active');loadScript("https://api-maps.yandex.ru/2.1/?lang=ru_RU&amp;loadByRequire=1",function(){ymaps.load(init);});}});}
$(function(){ymap();});});});